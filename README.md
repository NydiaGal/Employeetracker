...
2. Application
to present the following options: 
view all departments, 
view all roles, 
view all employees, 
POST/add a department, 
POST/add a role, 
POST/add an employee, and 
...
PUT/update an employee role
    ...
    THEN I am presented with a formatted table showing employee data, including employee ids, first names, last names, job titles, departments, salaries, and managers that the employees report 

    WHEN I choose to POST/add a department
    THEN I am prompted to enter the name of the department and that department is added to the database

    WHEN I choose to POST/add a role
    THEN I am prompted to enter the name, salary, and department for the role and that role is added to the database

    WHEN I choose to POST/add an employee
    THEN I am prompted to enter the employee’s first name, last name, role, and manager, and that employee is added to the database

    WHEN I choose to PUT/update an employee role
